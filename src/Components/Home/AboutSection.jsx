...
import { Target, Eye, Award, Users, Globe, ArrowRight, CheckCircle, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative">
        ...
        <div className={`text-center mb-16 transform transition-all duration-1000 ${getVisibilityClass('main')}`}>
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            About <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Sheba</span> Software Solutions
          </h2>
