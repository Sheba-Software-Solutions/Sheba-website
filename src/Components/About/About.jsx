...
function About() {
  return (
    <div id="about" className="bg-letters-secondary py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-letters-primary sm:text-4xl">
        ...
        <div className="mt-20">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="bg-white p-6 rounded-lg shadow-sm hover:transform hover:-translate-y-1 hover:shadow-xl hover:bg-blue-50 transition-all duration-300">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-blue-50 text-letters-accent">
                <FontAwesomeIcon icon={faMicrochip} className="text-xl icon-animate" />
              </div>
              <div className="mt-6">
                <h3 className="text-lg font-medium text-letters-primary">Innovative Solutions</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm hover:transform hover:-translate-y-1 hover:shadow-xl hover:bg-blue-50 transition-all duration-300">
              ...
              <div className="mt-6">
                <h3 className="text-lg font-medium text-letters-primary">Navigate like a wind</h3>
                <p className="mt-2 text-base text-gray-500">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm hover:transform hover:-translate-y-1 hover:shadow-xl hover:bg-blue-50 transition-all duration-300">
              ...
              <div className="mt-6">
                <h3 className="text-lg font-medium text-letters-primary">Crafted with passion</h3>
                <p className="mt-2 text-base text-gray-500">
        ...
        <div className="mt-20 bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="md:flex">
            ...
            <div className="p-8">
              <div className="uppercase tracking-wide text-sm text-letters-accent font-semibold">Our story</div>
              <h3 className="mt-2 text-2xl font-semibold text-letters-primary">
              ...
              <div className="mt-6">
                <button className="team-button text-letters-accent font-medium hover:text-blue-600 transition transform hover:scale-105 focus:scale-105 focus:outline-none focus:ring-2 focus:ring-letters-accent focus:ring-offset-2">
